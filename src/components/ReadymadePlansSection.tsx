...
const OPTIONS = [
  { id: 1, label: "House Planning", category: "Architect / Civil engineer / Interior Designer", icon: FileImage, color: "bg-blue-500/10 text-blue-600" },
  { id: 2, label: "Architect", category: "Architect / Civil engineer / Interior Designer", icon: PenTool, color: "bg-indigo-500/10 text-indigo-600" },
  { id: 3, label: "Contractor", category: "Civil Construction", icon: BrickWall, color: "bg-amber-500/10 text-amber-600" },
  { id: 4, label: "Electrical Contractor", category: "Electrical Contractor", icon: Plug, color: "bg-yellow-500/10 text-yellow-600" },
  { id: 5, label: "Plumbing Contractor", category: "Plumbing Contractor", icon: Wrench, color: "bg-sky-500/10 text-sky-600" },
  { id: 6, label: "Tiles Contractor", category: "Tiles & Granite Contractor", icon: Component, color: "bg-teal-500/10 text-teal-600" },
  { id: 7, label: "Painting Contractor", category: "Painting & Waterproofing Contractor", icon: Palette, color: "bg-rose-500/10 text-rose-600" },
  { id: 8, label: "Swimming Pool Contractor", category: "Swimming Pool Contractors", icon: LifeBuoy, color: "bg-cyan-500/10 text-cyan-600" },
  { id: 9, label: "Pre Engineered Building Contractor", category: "Pre Engineering Board Services / PEB", icon: Warehouse, color: "bg-emerald-500/10 text-emerald-600" },
  { id: 10, label: "Pre Fabricated Building", category: "Pre Fabricated House", icon: Package, color: "bg-violet-500/10 text-violet-600" },
  { id: 11, label: "Pest Control", category: "Pest Control", icon: ShieldAlert, color: "bg-red-500/10 text-red-600" },
  { id: 12, label: "Landscaping or Garden Contractor", category: "Landscaping & Garden Contractor", icon: Flower2, color: "bg-green-500/10 text-green-600" },
  { id: 13, label: "Manpower Supply", category: "Manpower Supply", icon: UsersRound, color: "bg-fuchsia-500/10 text-fuchsia-600" },
  { id: 14, label: "Modular Kitchen Services", category: "Modular Kitchen Services", icon: UtensilsCrossed, color: "bg-orange-500/10 text-orange-600" },
  { id: 15, label: "Lift Installation Services", category: "Lift Services", icon: ArrowUpSquare, color: "bg-purple-500/10 text-purple-600" },
  { id: 16, label: "Pre Cast Materials", category: "Marketplace / Material / Procurement Requirements", icon: Blocks, color: "bg-stone-500/10 text-stone-600" },
  { id: 17, label: "Building Inspection Services", category: "Building Inspection", icon: SearchCheck, color: "bg-slate-500/10 text-slate-600" },
  { id: 18, label: "Solar Panel Contractor", category: "Solar Rooftop Panel Services", icon: SunDim, color: "bg-amber-600/10 text-amber-700" },
  { id: 19, label: "HVAC Contractor", category: "HVAC Contractors", icon: Snowflake, color: "bg-blue-600/10 text-blue-700" },
  { id: 20, label: "Building Material Services", category: "Marketplace / Material / Procurement Requirements", icon: ShoppingBasket, color: "bg-orange-600/10 text-orange-700" },
];
