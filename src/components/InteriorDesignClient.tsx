...
const InteriorDesignClient = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("requestType", "Interior Design Customization");
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4 tracking-tight">
              <span className="text-orange-600">Interior Design</span>
            </h1>
            <p className="text-lg text-gray-600 max-w-xl mx-auto">
              Share your interior design requirements below. Our expert
              interior designers will create a stunning look tailored just for you.
            </p>
          </div>
...
export default InteriorDesignClient;