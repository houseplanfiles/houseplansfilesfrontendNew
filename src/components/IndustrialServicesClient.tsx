      ...
      <div className="relative bg-gray-900 py-12 sm:py-20 overflow-hidden w-full">
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center px-4">
            <Button onClick={() => router.push("/register?role=industrial")} className="w-full sm:w-auto bg-orange-600 hover:bg-orange-700 py-6 px-8 rounded-full shadow-lg transition-transform hover:scale-105">
