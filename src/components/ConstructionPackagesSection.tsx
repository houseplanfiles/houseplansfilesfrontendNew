...
const ConstructionPackagesSection: React.FC<ConstructionPackagesProps> = ({
  packages,
}) => {
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 tracking-tight">
            City Contractor <span className="text-orange-600">Opportunities</span>
          </h2>
        ...
        <div className="block md:hidden">
          ...
          {hasMoreMobile && (
            <div className="text-center mt-6">
              ...
              >
                {showAllMobile ? "Show Less" : "View All Opportunities"}
                {showAllMobile ? (
...
export default ConstructionPackagesSection;
