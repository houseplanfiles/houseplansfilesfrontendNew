...
const HOME_SERVICES = [
  { id: 1, label: "House Planning", link: "/home-designing-services?profession=Architect", icon: Home, color: "bg-blue-500/10 text-blue-600 hover:border-blue-500" },
  { id: 2, label: "Architect", link: "/home-designing-services?profession=Architect", icon: Compass, color: "bg-indigo-500/10 text-indigo-600 hover:border-indigo-500" },
  { id: 3, label: "Contractor (Building & Interior)", link: "/home-designing-services?profession=Building", icon: HardHat, color: "bg-amber-500/10 text-amber-600 hover:border-amber-500" },
