...
const customServices = [
  ...
  {
    name: "Complete House Plan Files",
    description:
      "Get complete house plan files including all architectural details and designs.",
    image: "/completehouse.jpg",
    icon: Sofa,
    bgColor: "bg-teal-100",
    iconColor: "text-teal-500",
    href: "/customize/complete-house-plans",
  },
  {
    name: "Custom interior design",
    description:
      "Get a custom interior design tailored to your space, style, and budget.",
    image: "/elevation3d.jpg",
    icon: Sofa,
    bgColor: "bg-green-100",
    iconColor: "text-green-500",
    href: "/customize/interior-design",
  },
];
