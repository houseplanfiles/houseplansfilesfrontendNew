        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center space-x-3 mb-6">
              ...
              />
              <span className="text-xl font-bold text-white">HousePlanFiles</span>
            </Link>
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Creating exceptional architectural designs for over 15 years. Your dream home starts with the perfect plan.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-muted-foreground">Bareli, Madhya Pradesh, 464668, India</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-primary flex-shrink-0" />
                <a href="#" onClick={(e) => handleCallClick(e, "+918815939484")} className="text-muted-foreground hover:text-primary transition-colors">
                  +91 88 159 394 84
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-primary flex-shrink-0" />
                <a href="mailto:houseplansdesignsfile@gmail.com" className="text-muted-foreground hover:text-primary transition-colors break-all">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-4 bg-white px-3 py-2 rounded-lg">
                <img src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/razorpay-icon.png" alt="Razorpay" width="60" height="24" loading="lazy" className="h-6 object-contain" />
                <img src="https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg" alt="PayPal" width="60" height="24" loading="lazy" className="h-6 object-contain" />
                <img src="https://download.logo.wine/logo/PhonePe/PhonePe-Logo.wine.png" alt="PhonePe" width="60" height="24" loading="lazy" className="h-6 object-contain" />
              </div>
            </div>
