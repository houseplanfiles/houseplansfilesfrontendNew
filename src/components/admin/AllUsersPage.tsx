        ...
        >
          <DialogContent className="sm:max-w-[425px]">
            ...
            >
              ...
              {(["professional", "contractor", "seller", "architect"].includes(role?.toLowerCase()?.trim() || "")) && (
                <div>
                  <Label>Account Type / Listing Plan</Label>
                  <Select
              ...
              {(["professional", "contractor", "seller", "architect"].includes(role?.toLowerCase()?.trim() || "")) && (contractorType === "Premium" || contractorType === "Verified") && (
                <div className="space-y-1">
                  ...
                  />
                  <p className="text-xs text-gray-500">Set listing duration: 6 months, 1 year, etc. After this date, user will revert to Normal.</p>
                </div>
              )}
