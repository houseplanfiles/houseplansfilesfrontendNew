...
const HOME_SERVICES = [
  { id: 1, label: "Architects & engineers", link: "/home-designing-services?profession=Architect", icon: Home, color: "bg-blue-500/10 text-blue-600 hover:border-blue-500" },
  { id: 2, label: "Interior designer", link: "/home-designing-services?profession=Architect", icon: Compass, color: "bg-indigo-500/10 text-indigo-600 hover:border-indigo-500" },
  ...
  { id: 6, label: "Tiles & Stone Contractor", link: "/home-designing-services?profession=Tile & granite", icon: Grid, color: "bg-teal-500/10 text-teal-600 hover:border-teal-500" },
  { id: 7, label: "Painting Contractor", link: "/home-designing-services?profession=Painting", icon: Paintbrush, color: "bg-rose-500/10 text-rose-600 hover:border-rose-500" },
  ...
  { id: 16, label: "False Ceiling Contractor", link: "/home-designing-services?profession=Interior", icon: Layers, color: "bg-fuchsia-500/10 text-fuchsia-600 hover:border-fuchsia-500" },
...
const INDUSTRIAL_SERVICES = [
  { id: 1, label: "Pre Engineering Buildings", link: "/industrial-services?profession=Building", icon: Building2, color: "bg-emerald-500/10 text-emerald-600 hover:border-emerald-500" },
  { id: 2, label: "Pre Fabricated Buildings", link: "/industrial-services?profession=Building", icon: Layers, color: "bg-violet-500/10 text-violet-600 hover:border-violet-500" },
  ...
  { id: 7, label: "Bulk Building Material Services", link: "/marketplace?category=Building Material", icon: Wrench, color: "bg-orange-600/10 text-orange-700 hover:border-orange-600" },
];
...
const OTHER_SERVICES = [
  ...
  { id: 10, label: "HVAC System Installation", link: "/other-services?profession=Electrical", icon: Wind, color: "bg-blue-600/10 text-blue-700 hover:border-blue-600" },
  ...
  { id: 18, label: "Home Automation", link: "/other-services?profession=Electrical", icon: Zap, color: "bg-yellow-600/10 text-yellow-700 hover:border-yellow-600" },
  { id: 15, label: "Water Proofing Installation", link: "/other-services?profession=Building", icon: Shield, color: "bg-sky-600/10 text-sky-700 hover:border-sky-600" },
  { id: 8, label: "Garden & Landscaping Contractor", link: "/other-services?profession=Interior", icon: Leaf, color: "bg-green-500/10 text-green-600 hover:border-green-500" },
  { id: 17, label: "Modular Kitchen Services", link: "/other-services?profession=Interior", icon: ChefHat, color: "bg-orange-500/10 text-orange-600 hover:border-orange-500" },
