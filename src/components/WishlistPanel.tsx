...
const house3 = "/floorplan1.jpg"; // एक फॉलबैक इमेज
        ...
        {wishlistItems.length === 0 ? (
          <div className="flex-grow flex flex-col items-center justify-center text-center p-6 text-muted-foreground">
            ...
            <Button asChild className="mt-6" onClick={onClose}>
              <Link href="/house-plans">Explore Plans</Link>
            </Button>
          </div>
        ) : (
          <div className="flex-grow overflow-y-auto p-6 space-y-4">
            {wishlistItems.map((item) => {
              ...
              return (
                ...
                >
                  <Link href={`/house-plans/${item.productId}`} onClick={onClose}>
                    <img
                      src={itemImage}
                      alt={itemName}
                  ...
                  <div className="flex-grow">
                    <Link
                      href={`/house-plans/${item.productId || "/house-plans"}`}
                      onClick={onClose}
