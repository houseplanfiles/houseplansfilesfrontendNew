...
const Products = ({
  ...
  const plotSizeQuery = searchParams?.get("plotSize");

  const [filters, setFilters] = useState({
    category: categoryQuery || "all",
    searchTerm: searchQuery || "",
    plotSize: plotSizeQuery || "all",
    plotArea: "all",
    direction: "all",
    floors: "all",
    propertyType: "all",
  ...
  // Sync URL params → filter state when URL changes (from ProductsClientWrapper)
  useEffect(() => {
    setFilters((prev: any) => ({
      ...prev,
      searchTerm: searchQuery || "",
  ...
  }, [searchQuery, categoryQuery, plotSizeQuery]);
  ...
  }, [debouncedSearchTerm, filters, countryQuery]);
